...
public class TrelloManager{
    ...
    private static final Trello trello = new TrelloImpl("e3ee0d6a1686b4b43ba5d046bbce20af","ADD YOUR TOKEN HERE");
    private static final Board board = trello.getBoard("614de300aa6df33863299b6c");  // board (projeto)
    private static final List<Member> members = trello.getMembersByBoard(BOARD_ID,null); // members list (if needed)
